...
const PreviewEntidad = ({entidad}) => {
  ...
  return (
    <div className='border-b p-5'>
        ...
        >
            <img class="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="https://www.valoraanalitik.com/wp-content/uploads/2021/04/Bancolombia1.jpg"></img>
